...
Sessions are active connections between your application and MCP server deployments.
...
Think of a session like a phone call — it's an active connection that stays open while you need it, then closes when you're done.
...
<CardGroup cols={2}>
  <Card title="OAuth Guide" icon="lock" href="/sdk-oauth-overview">
